...
type = 12; % 1 : image_alex_fe; 2: image_alex_ft; 3 : image small_nets; 4 fe + small_nets; 5 : social_cnn; 6 social_mlp;
...
fe_alexnet_proto = 'social-model-hk/transfer_ft/fe_alexnet.prototxt';
solver_fe_proto = 'social-model-hk/transfer_ft/fe_solver_alexnet.prototxt';
weights_fe_file = ['social-model-hk/transfer_ft/results/fe_alexnet_classifier','_iter_',num2str(iternum(1)) ,'.caffemodel'];
...
tr_sample_index = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Social_Training_Samples';
val_sample_index = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Social_Testing_Samples';
sample_image = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Social_Sample_Images';

social_sample_image = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Social_Data';
mean_social_file = 'social-model-hk/social-data-mean.mat';

if (type < 5),
    test_ft_proto = ['social-model-hk/transfer_ft/ft', num2str(type), '_alex_test.prototxt'];
    solver_ft_proto = ['social-model-hk/transfer_ft/ft', num2str(type), '_solver_alexnet.prototxt'];
    weights_ft_file = ['social-model-hk/transfer_ft/results/ft', num2str(type), '_alexnet_iter_', ...
        num2str(iternum(1)), '.caffemodel'];
    weights_small_file = ['social-model-hk/transfer_ft/results/ft3_alexnet_iter_', ...
            num2str(iternum(1)), '.caffemodel'];
elseif (type >= 5 && type < 7)
    test_ft_proto = ['social-model-hk/social-only/', num2str(type), 'feat_socialdata.prototxt'];
    solver_ft_proto = ['social-model-hk/social-only/', num2str(type), 'solver_socialdata.prototxt'];
    weights_ft_file = ['social-model-hk/social-only/results/cnn_socialdata_', num2str(type), 'train_iter_', ...
        num2str(iternum(1)), '.caffemodel'];
    ...
    solver_ft_proto = ['social-model-hk/union/ft', num2str(type), '_solver_alexnet.prototxt'];
    weights_ft_file = ['social-model-hk/union/results/ft', num2str(type), '_alexnet_iter_', ...
        num2str(iternum(1)), '.caffemodel'];
    weights_img_so_file = ['social-model-hk/union/results/ft8_alexnet_iter_', ...
            num2str(iternum(1)), '.caffemodel'];
    weights_so_file = ['social-model-hk/social-only/results/cnn_socialdata_5train_iter_', ...
            num2str(iternum(1)), '.caffemodel'];
    weights_alex_so_file = ['social-model-hk/union/results/ft7_alexnet_iter_', ...
            num2str(iternum(1)), '.caffemodel'];
    weights_small_file = ['social-model-hk/transfer_ft/results/ft3_alexnet_iter_', ...
            num2str(iternum(1)), '.caffemodel'];
    weights_alex_img_file = ['social-model-hk/transfer_ft/results/ft4_alexnet_iter_', ...
            num2str(iternum(1)), '.caffemodel'];
end
