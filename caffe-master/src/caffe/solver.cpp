...
// begin: zhaoys, Apr. 5, 2016
    if (param_.train_trace_interval()
      ...
      new_point->set_train_smoothed_loss(smoothed_loss_);
    }
// end: zhaoys, Apr. 5, 2016
...
// begin: zhaoys, Apr. 5, 2016,
    if (param_.train_trace_interval()
      ...
      TrainTracePoint* new_point = trace_.add_train_trace_point();
      new_point->set_iter(iter_);
      new_point->set_result_name(output_name);
      new_point->set_loss_weight(loss_weight);
      new_point->set_train_result(result_vec[k]);
    }
// end: zhaoys, Apr. 5, 2016
