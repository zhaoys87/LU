clc; 
%% demo_transfer_ft_stacked_hkwv3
...
type = 2; % 1 : fine tuning RGB; 2: training alexnet; 3 : small nets full channels; 4 coupled dcnn; 9 : reduction fine tuning

weights_alexnet_file = 'bvlc_alexnet/bvlc_alexnet.caffemodel';
fe_alexnet_proto = 'hk-wv3/transfer_ft/fe_alexnet.prototxt';
solver_fe_proto = 'hk-wv3/transfer_ft/fe_solver_alexnet.prototxt';
weights_fe_file = ['hk-wv3/transfer_ft/results/fe_alexnet_classifier','_iter_',num2str(iternum(1)) ,'.caffemodel'];

test_ft_proto = ['hk-wv3/transfer_ft/ft', num2str(type), '_alex_test.prototxt'];
solver_ft_proto = ['hk-wv3/transfer_ft/ft', num2str(type), '_solver_alexnet.prototxt'];
weights_ft_file = ['hk-wv3/transfer_ft/results/ft', num2str(type), '_alexnet_iter_', ...
    num2str(iternum(1)), '.caffemodel'];

if(type == 4)
weights_small_file = ['hk-wv3/transfer_ft/results/ft', num2str(3), '_alexnet_iter_', ...
    num2str(iternum(1)), '.caffemodel'];
weights_ft1_file = ['hk-wv3/transfer_ft/results/ft', num2str(1), '_alexnet_iter_', ...
    num2str(iternum(1)), '.caffemodel'];
end

tr_sample_index = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Training_Samples';
val_sample_index = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Testing_Samples';
sample_image = '/home/zhaoys/Documents/deep_learning/Scene_HSRI/HK-WV3/Sample_Images';
